...
/*
========================
Changes to SPL5 compiler
========================
Added tokens
   (pseudo-terminals)
   (  reserved words) PROCEDURE IN OUT IO REF CALL RETURN
   (     punctuation)
   (       operators)
...
//****************************************************
//**** TOKENTYPE and TOKENTABLE *MUST* be parallel ***
//****************************************************
...
// Use "panic mode" error recovery technique: report error message and terminate compilation!
   ...
   lister.ListInformationLine(information);
   lister.ListInformationLine("SPL6 compiler ending with compiler error!\n");
   throw( SPLEXCEPTION("SPL6 compiler ending with compiler error!") );
}
...
// ENDCODEGENERATION
   ...
   lister.ListInformationLine("******* SPL6 compiler ending");
   cout << "SPL6 compiler ending\n";
