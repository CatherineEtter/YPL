...
// Use "panic mode" error recovery technique: report error message and terminate compilation!
   ...
   lister.ListInformationLine(information);
   lister.ListInformationLine("SPL8 compiler ending with compiler error!\n");
   throw( SPLEXCEPTION("SPL8 compiler ending with compiler error!") );
}
...
// ENDCODEGENERATION
   ...
   lister.ListInformationLine("******* SPL8 compiler ending");
   cout << "SPL8 compiler ending\n";
