...
// Use "panic mode" error recovery technique: report error message and terminate compilation!
   ...
   lister.ListInformationLine(information);
   lister.ListInformationLine("SPL3 compiler ending with compiler error!\n");
   throw( SPLEXCEPTION("SPL3 compiler ending with compiler error!") );
}
...
// ENDCODEGENERATION
   ...
   lister.ListInformationLine("******* SPL3 compiler ending");
   cout << "SPL3 compiler ending\n";
