...
// Use "panic mode" error recovery technique: report error message and terminate compilation!
   ...
   lister.ListInformationLine(information);
   lister.ListInformationLine("SPL4 compiler ending with compiler error!\n");
   throw( SPLEXCEPTION("SPL4 compiler ending with compiler error!") );
}
...
// ENDCODEGENERATION
   ...
   lister.ListInformationLine("******* SPL4 compiler ending");
   cout << "SPL4 compiler ending\n";
