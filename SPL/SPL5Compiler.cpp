...
// Use "panic mode" error recovery technique: report error message and terminate compilation!
   ...
   lister.ListInformationLine(information);
   lister.ListInformationLine("SPL5 compiler ending with compiler error!\n");
   throw( SPLEXCEPTION("SPL5 compiler ending with compiler error!") );
}
...
// ENDCODEGENERATION
   ...
   lister.ListInformationLine("******* SPL5 compiler ending");
   cout << "SPL5 compiler ending\n";
